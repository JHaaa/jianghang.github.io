  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '50vh' }}>
      ...
      <div style={{ maxWidth: '800px', textAlign: 'justify' }}>
        ...
        <p>
        I am a PhD candidate in the <a href="https://www.comp.nus.edu.sg/disa/" target="_blank">
        ...
        Prior to joining NUS, I obtained a M.S. in Probability and Mathematical Statistics
         from the <a href="https://science-en.sustech.edu.cn/research/depart/id/263.html" target="_blank">
        Department of Mathematics</a> at the Southern University of Science and Technology (SUSTech)
         and a B.S. in Statistics from the <a href="https://en.wikipedia.org/wiki/Special_Class_for_the_Gifted_Young#University_of_Science_and_Technology_of_China" target="_blank">
            Special Class for the Gifted Young</a> at the 
        ...
        <p>Find me on <a href="https://twitter.com/CyberHang" target="_blank">X</a>.</p>
      </div>
    </div>
  );
}
